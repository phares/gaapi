...
class PolicySerializer(serializers.Serializer):
    ...
    online_ref_no = serializers.CharField(read_only=True, max_length=99, required=False)
    cust_code = serializers.CharField(read_only=True, max_length=99, required=False)
    cust_name = serializers.CharField(read_only=True, max_length=99, required=False)
